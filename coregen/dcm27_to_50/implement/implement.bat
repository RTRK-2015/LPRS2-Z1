...
xst -ifn xst.scr
move dcm27_to_50_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dcm27_to_50_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm27_to_50_exdes.ucf dcm27_to_50_exdes

echo 'Running map'
map -timing -pr b dcm27_to_50_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm dcm27_to_50_exdes -w routed.ncd routed.vhd
cd ..
